...
kubectl set image deployments/client-deployment server=phareesh76/multi-client:$SHA
kubectl set image deployments/worker-deployment server=phareesh76/multi-worker:$SHA
